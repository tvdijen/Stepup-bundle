...
class CountryCode
{
     ...
     * @var string
     */
    private $countryCodeDefinition;

    /**
     * @param string $countyCodeDefinition
     */
    public function __construct($countyCodeDefinition)
    {
        if (!is_string($countyCodeDefinition)) {
            throw InvalidArgumentException::invalidType('string', 'countryCodeDefinition', $countyCodeDefinition);
        }

        if (!array_key_exists($countyCodeDefinition, static::$countryCodes)) {
            throw UnknownCountryCodeException::unknownDefinition($countyCodeDefinition);
        }

        $this->countryCodeDefinition = $countyCodeDefinition;
    }
    ...
    {
        return static::$countryCodes[$this->countryCodeDefinition];
    }

    /**
     * @return string
     */
    public function getCountryCodeDefinition()
    {
        return $this->countryCodeDefinition;
    }
    ...
    {
        return $this->countryCodeDefinition === $other->countryCodeDefinition;
    }
     ...
     * @return array
     */
    public static function getAvailableCountryCodeDefinitions()
    {
        return array_keys(static::$countryCodes);
    }
}
